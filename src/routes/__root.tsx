...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "114 Rentals(A+) — Automotive Reserve" },
      ...
      { name: "author", content: "114 Rentals(A+)" },
      { property: "og:title", content: "114 Rentals(A+) — Automotive Reserve" },
      ...
      { name: "twitter:title", content: "114 Rentals(A+) — Automotive Reserve" },
